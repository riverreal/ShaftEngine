...
namespace shaderc
{
    ...
    const bgfx::Memory* compileShader(ShaderType type, const char* filePath, const char* includePath, const char* defines, const char* varyingPath, const char* profile)
    {
        ...
        // set varyingdef
        std::string defaultVarying = std::string(includePath) + "/DefaultVaryingDef.sc";
